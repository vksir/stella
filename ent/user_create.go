...
func (_c *UserCreate) SetQq(v string) *UserCreate {
	_c.mutation.SetQq(v)
	return _c
}

// SetQqID sets the "qq_id" field.
func (_c *UserCreate) SetQqID(v int64) *UserCreate {
	_c.mutation.SetQqID(v)
	return _c
}
...
func (_c *UserCreate) check() error {
	if _, ok := _c.mutation.Qq(); !ok {
		return &ValidationError{Name: "qq", err: errors.New(`ent: missing required field "User.qq"`)}
	}
	if _, ok := _c.mutation.QqID(); !ok {
		return &ValidationError{Name: "qq_id", err: errors.New(`ent: missing required field "User.qq_id"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.Qq(); ok {
		_spec.SetField(user.FieldQq, field.TypeString, value)
		_node.Qq = value
	}
	if value, ok := _c.mutation.QqID(); ok {
